  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    hasEndBlockOver ? (
      <>
        ...
        <LinkExternal href="https://twitter.com/shaolinToken">
      ...
      <>
        ...
        <LinkExternal href="https://medium.com/shaolinToken/initial-farm-offering-ifo-3-0-ifo-staking-pool-622d8bd356f1">
